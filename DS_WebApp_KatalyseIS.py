...
if (file is not None):
    ...
    if (file_format == "xlsx"):
        ...
        st.write("Sélectionner le séparateur")
        if st.checkbox(","):
                ...
                if (mvo == "Supprimer les données contenant des valeurs manquantes"):
                    ...
                    if (nd == "Nettoyer l'ensemble du dataframe"):
                        ...
                        if st.button("Voir et enregistrer l'opération"):
                            ...
                            affichage_apres_processing("NDF")
                        ...
                        if st.button("Voir et enregistrer l'opération"):
                            ...
                            affichage_apres_processing("NLC")
                    ...
                    if st.button("Voir et enregistrer l'opération"):
                        ...
                        affichage_apres_processing("RVM")
                ...
                if (bp == "Méthodes de normalisation"):
                    ...
                    if (mn == "StandardScaler"):
                        ...
                        if st.button("Voir et enregistrer l'opération"):
                            ...
                            st.session_state.X_train[var_choisi] = scaler.fit_transform(st.session_state.X_train[var_choisi])
                            st.session_state.X_test[var_choisi] = scaler.transform(st.session_state.X_test[var_choisi])
                            affichage_apres_processing("MMS")
                        ...
                        if st.button("Voir et enregistrer l'opération"):  
                            ...
                            st.session_state.X_train[var_choisi] = scaler.fit_transform(st.session_state.X_train[var_choisi])
                            st.session_state.X_test[var_choisi] = scaler.transform(st.session_state.X_test[var_choisi])
                            affichage_apres_processing("MAS")
                        ...
                        if st.button("Voir et enregistrer l'opération"): 
                            ...
                            st.session_state.X_train[var_choisi] = scaler.fit_transform(st.session_state.X_train[var_choisi])
                            st.session_state.X_test[var_choisi] = scaler.transform(st.session_state.X_test[var_choisi])
                            affichage_apres_processing("NRM")
                    ...
                    if (ec == "OrdinalEncoder"):
                        ...
                        if st.button("Voir et enregistrer l'opération"):
                            ...
                            affichage_apres_processing("OHE")
                    ...
                    if (ds == "KBinsDiscretizer"):
                            ...
                            if st.button("Voir et enregistrer l'opération"):
                                ...
                                st.session_state.X_train[var_a_discretiser] = kbd.fit_transform(st.session_state.X_train[var_a_discretiser])
                                st.session_state.X_test[var_a_discretiser] = kbd.transform(st.session_state.X_test[var_a_discretiser])
                                affichage_apres_processing("KBD")
                            ...
                            if st.button("Voir et enregistrer l'opération"):
                                ...
                                st.session_state.X_train[var_a_discretiser] = bnr.fit_transform(st.session_state.X_train[var_a_discretiser])
                                st.session_state.X_test[var_a_discretiser] = bnr.transform(st.session_state.X_test[var_a_discretiser])
                                affichage_apres_processing("BNR")
                ...
                if (mm == "classification"):
                    ...
                    if (cm == "SVM"):
                        ...
                        if (gr == "Manuel"):
                            ...
                            n_estimators = st.number_input("Nombre d'arbres de décision", "Entrer un nombre entier")
                            ...
                            max_depth = st.number_input("Profondeur d'un arbre","Entrer un nombre entier")
                        ...
                        if st.button("Lancer l'entraînement avec optimisation baysienne"):
                            ...
                            st.text(list(bayes_cv_tuner.best_params_.items()))
                            st.write("ROC-AUC :")
                    ...
                    if (cm == "SVR"):
                        ...
                        if (gr == "Manuel"):
                            ...
                            if st.button("Lancer l'entraînement"):
                                ...
                                regressor.fit(st.session_state.X_train, st.session_state.y_train)
                                st.text(regressor.best_params_)
